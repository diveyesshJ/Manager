...
module.exports = {
    ...
    let guild = client.guilds.cache.get("941362510194417704")
    
    const control = new Discord.MessageEmbed()
      .setColor(`BLUE`)
      .setAuthor(`${client.user.username} | Bot-Control-Panel`, client.user.displayAvatarURL())
      .setDescription(`<:arrow:1084432472311337022> **Bot-File-Path:**
\`\`\`yml
${process.cwd()}
\`\`\`
<:arrow:1084432472311337022> **Host-Server:**
\`\`\`yml
...
\`\`\`
${clientapp ? `<:arrow:1084432472311337022> **Bot-Application-Information:**
\`\`\`yml
...
\`\`\`
<:arrow:1084432472311337022> **About me:**
\`\`\`yml
